 ...
 * This one is modified to copy the value of P9_15 to P9_16
...
static unsigned int gpioLED = 51;       ///< hard coding the LED gpio for this example to P9_16 
static unsigned int gpioButton = 48;   ///< hard coding the button gpio for this example to P9_15
 ...
 */
static irq_handler_t ebbgpio_irq_handler(unsigned int irq, void *dev_id, struct pt_regs *regs){
  ledOn = gpio_get_value(gpioButton);                          // Read the button. 
